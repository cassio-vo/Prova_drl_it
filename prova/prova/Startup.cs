...
namespace prova
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IArvoreBusiness, ArvoreBusinessImplementation>();
            services.AddScoped<IColheitaBusiness, ColheitaBusinessImplementation>();
            services.AddScoped<IEspecieBusiness, EspecieBusinessImplementation>();
            services.AddScoped<IGrupoArvoreBusiness, GrupoArvoreBusinessImplementation>();
